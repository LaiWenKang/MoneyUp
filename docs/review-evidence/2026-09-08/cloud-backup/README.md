...
![Recovery password and explicit backup enablement](cloud-recovery-setup-en.png)

## Connect — Simplified Chinese

![连接 iCloud 账户](cloud-connect-zh-Hans.png)

## Enable backup — Simplified Chinese

![设置恢复密码并明确启用备份](cloud-recovery-setup-zh-Hans.png)
