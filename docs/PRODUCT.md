...
| Navigation | Five permanent tabs: Today, History, center Log, Plan, and Assets; optional deliberate left/right swipes work only from passive space so child controls retain their gestures |
